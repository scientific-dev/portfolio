...
export const Projects = [
  {
    name: "Spotify-api.js",
    description:
      "A npm package to interact with spotify api with node.js with oauth support. This package also supports caching!",
  ...
  },
  {
    name: "Enhanced.db",
    description:
      "A npm package which is a wrapper for better-sqlite3! Currently not maintained...",
  ...
  },
  {
    name: "Instant.db",
    description:
      "Instant.db helps you to make database instantly using json files for Node.js!",
  ...
  },
  {
    ...
    description:
      "Timeline of India is a website which shows the events from the very first of the Indus civilization of the Indian subcontinent to the current state of the Indian subcontinent.",
    languages: ["Svelte", "Javascript"],
    link: "https://timelineofindia.github.io",
    buttons: [makeBtn("https://github.com/timelineofindia", "GitHub")],
  },
  {
    name: "Templatify",
    description:
  ...
  },
  {
    name: "EvtManager",
    description:
      "Simple to use eventemitter to manage your events synchronously and asynchronously too for Deno, Node and browser with a typesafe environment!",
  ...
  },
  {
    ...
    description:
      "A custom socket for deno to add custom headers which lacks in the standard library!",
